...
class Population(Base):
    ...
    std_date    = Column(Date,    nullable=False)   # 기준일자 (STDR_DE_ID). 20260610→2026-06-10
    time_zone   = Column(String(5), nullable=False) # 시간대구분 (TMZON_PD_SE). 00=해당 시간대
    ...
    male_70o    = Column(Numeric(10, 4), nullable=True)  # MALE_F70T74_LVPOP_CO (70세 이상 최고령)
    ...
    female_70o   = Column(Numeric(10, 4), nullable=True)  # FEMALE_F70T74_LVPOP_CO (70세 이상 최고령)
