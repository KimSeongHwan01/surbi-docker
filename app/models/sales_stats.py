...
class SalesStat(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "district_id", "category_code", "period_code"
        ),  # 중복 적재 방지
    )
    ...
    )  # 기준년분기 (STDR_YYQU_CD). 예: 20211
    category_code = Column(
        String(20), nullable=False
    )  # 서비스업종코드 (SVC_INDUTY_CD). UNIQUE 기준키
    ...
    monthly_sales_count = Column(
        BigInteger, nullable=True
    )  # 당월매출건수 (THSMON_SELNG_CO)
    ...
    # 시간대별 매출금액
    tmzon_00_06_sales = Column(
        BigInteger, nullable=True
    )  # 00~06시 (TMZON_00_06_SELNG_AMT)
    tmzon_06_11_sales = Column(
        BigInteger, nullable=True
    )  # 06~11시 (TMZON_06_11_SELNG_AMT)
    tmzon_11_14_sales = Column(
        BigInteger, nullable=True
    )  # 11~14시 (TMZON_11_14_SELNG_AMT)
    tmzon_14_17_sales = Column(
        BigInteger, nullable=True
    )  # 14~17시 (TMZON_14_17_SELNG_AMT)
    tmzon_17_21_sales = Column(
        BigInteger, nullable=True
    )  # 17~21시 (TMZON_17_21_SELNG_AMT)
    tmzon_21_24_sales = Column(
        BigInteger, nullable=True
    ...
    age60_sales = Column(
        BigInteger, nullable=True
    )  # 60대이상 (AGRDE_60_ABOVE_SELNG_AMT)
    ...
    # 시간대별 매출건수
    tmzon_00_06_count = Column(
        BigInteger, nullable=True
    )  # 00~06시 (TMZON_00_06_SELNG_CO)
    tmzon_06_11_count = Column(
        BigInteger, nullable=True
    )  # 06~11시 (TMZON_06_11_SELNG_CO)
    tmzon_11_14_count = Column(
        BigInteger, nullable=True
    )  # 11~14시 (TMZON_11_14_SELNG_CO)
    tmzon_14_17_count = Column(
        BigInteger, nullable=True
    )  # 14~17시 (TMZON_14_17_SELNG_CO)
    tmzon_17_21_count = Column(
        BigInteger, nullable=True
    )  # 17~21시 (TMZON_17_21_SELNG_CO)
    tmzon_21_24_count = Column(
        BigInteger, nullable=True
    )  # 21~24시 (TMZON_21_24_SELNG_CO)
    ...
    age60_sales_count = Column(
        BigInteger, nullable=True
    )  # 60대이상 (AGRDE_60_ABOVE_SELNG_CO)
