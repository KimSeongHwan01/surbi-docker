"""add detail scores to scores table

Revision ID: 7121dcb64389
Revises: 7f02b9673f28
Create Date: 2026-08-19 22:23:55.959659
...
revision: str = "7121dcb64389"
down_revision: Union[str, None] = "7f02b9673f28"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("foot_traffic_index", sa.Numeric(5, 2), nullable=True),
        sa.Column("category_spending_power", sa.Numeric(5, 2), nullable=True),
        sa.Column("competition_intensity", sa.Numeric(5, 2), nullable=True),
        sa.Column("accessibility", sa.Numeric(5, 2), nullable=True),
        sa.Column("operation_stability", sa.Numeric(5, 2), nullable=True),
        sa.Column(
